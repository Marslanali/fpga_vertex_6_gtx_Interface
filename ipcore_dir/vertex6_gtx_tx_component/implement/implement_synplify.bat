...
COPY vertex6_gtx_tx_component_top.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\vertex6_gtx_tx_component_top.ucf -p xc6vsx315t-ff1156-2 vertex6_gtx_tx_component_top.edf vertex6_gtx_tx_component_top.ngd
