...
COPY vertex6_gtx_tx_component_top.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\vertex6_gtx_tx_component_top.ucf -p xc6vsx315t-ff1156-2 vertex6_gtx_tx_component_top.ngc vertex6_gtx_tx_component_top.ngd
...
ECHO 'Running NGD'
map -p xc6vsx315t-ff1156-2 -o mapped.ncd vertex6_gtx_tx_component_top.ngd
...
netgen -ofmt verilog -sim -sdf_path ../../implement/results -dir . -tm vertex6_gtx_tx_component_top -w routed.ncd routed.v
